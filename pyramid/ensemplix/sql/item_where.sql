SELECT DISTINCT owners.player AS owner, 1.*price/amount AS price_for_single, amount, price, shops_history.x, shops_history.y, shops_history.z
FROM shops_history
	JOIN (
...
ORDER BY price_for_single[DESC], amount, x, y, z;
